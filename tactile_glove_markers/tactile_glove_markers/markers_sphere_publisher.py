...
class TFMarkerPublisher(Node):
    ...
    def color_marker(self, marker_msg, microros_data, joint_id):
        ...
        if microros_data <= 6.67:
            marker_msg.color.r = 0.0
            marker_msg.color.g = 1.0    
            marker_msg.color.b = (6.67 - microros_data)/6.67
        elif microros_data <= 13.24:
            marker_msg.color.r = microros_data/13.24
            marker_msg.color.g = 1.0
        elif microros_data <= 20.0:
            marker_msg.color.g = (20.0 - microros_data)/13.24
